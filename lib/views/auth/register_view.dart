          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: const [
                    ...
                    Expanded(
                      child: Text(
                        "We'll send a verification code to your Polban email address.",
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _isLoading ? primaryOrange.withOpacity(0.6) : primaryOrange,
                    elevation: 0,
                  ...
                  child: _isLoading
                      ...
                      : const Text('Send Verification Code', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.white)),
                ),
              ),
              const SizedBox(height: 20),
              // Divider
              Center(child: Text('or', style: TextStyle(fontSize: 13, color: Colors.grey.shade500))),
              const SizedBox(height: 20),
              ...
              SizedBox(
                ...
                height: 48,
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(backgroundColor: Colors.white, elevation: 1, side: BorderSide(color: Colors.grey.shade200), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                  onPressed: _isLoading ? null : () async {
                    setState(() => _isLoading = true);
                    var result = await _registerController.signUpWithGoogle();
                    setState(() => _isLoading = false);
                    if (mounted) {
                      if (result['success'] && result['isNewUser'] == true) {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (_) => ProfileCompletionView(userData: result['userData']),
                          ),
                        );
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  child: _isLoading
                      ? const SizedBox(height: 20, width: 20, child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF2A2C8F)), strokeWidth: 2))
                      : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          SizedBox(width: 20, height: 20, child: Image.asset('assets/images/google_icon.png', errorBuilder: (_, __, ___) => const Icon(Icons.g_mobiledata, size: 26))),
                          const SizedBox(width: 10),
                          const Text('Sign up with Google', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFFF88031))),
                        ]),
                ),
              ),
              ...
              Center(
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  GestureDetector(onTap: _isLoading ? null : () => Navigator.pop(context), child: const Text('Login', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 13))),
                ]),
              ),
            ],
          ),
